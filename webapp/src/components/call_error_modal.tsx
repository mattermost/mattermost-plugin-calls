...
export const CallErrorModal = (props: Props) => {
    ...
    const onConfirm = () => {
        if (props.err.message === insecureContextErr.message) {
            window.open('https://mattermost.com/pl/calls-deployment', '_blank');
        }
        return null;
    };
    ...
    const onTroubleShootingClick = (ev: React.MouseEvent) => {
        ev.preventDefault();
        window.open('https://mattermost.com/pl/calls-make-troubleshooting', '_blank');
    };
            ...
            {formatMessage(
                ...
                },
                {
                    troubleShootingLink: (text: string) => (
                        <a
                            href='https://mattermost.com/pl/calls-make-troubleshooting'
