    ...
    return (
        ...
        >
            <label className={'control-label ' + leftCol}>
                {formatMessage({defaultMessage: 'Enable outbound phone number allowlist'})}
            </label>
            <div className={rightCol}>
                ...
                <div
                    ...
                    className='help-text'
                >
                    {formatMessage({defaultMessage: 'When set to true, only phone numbers listed in the allowlist below can be dialed. Intended for development and testing environments to prevent accidental calls to real numbers.'})}
                </div>
                {overridden &&
