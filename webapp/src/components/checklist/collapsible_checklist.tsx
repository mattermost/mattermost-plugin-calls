...
import {ChecklistItem, ChecklistItemState} from 'src/types/checklist';
...
export interface Props {
    ...
    disabled?: boolean;
    referenceID?: string;
    onRenameChecklist: (index: number, checklist: string, referenceID?: string) => void;
    ...
    if (isRenaming) {
        titleComp = (
            <ChecklistInputComponent
                ...
                onSave={() => {
                    onRenameChecklist(index, newChecklistTitle, referenceID);
