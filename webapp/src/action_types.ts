...
export const VOICE_CHANNEL_CALL_RECORDING_START = pluginId + '_voice_channel_call_recording_start';
export const VOICE_CHANNEL_CALL_RECORDING_END = pluginId + '_voice_channel_call_recording_end';
